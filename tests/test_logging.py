...
import aspen
from tests import LOG, assert_logs, assert_prints
...
Configuration(sys.argv) # sets logging
...
def test_command_line_trumps_aspen_conf():
    mk( ('aspen-test.py', LOGGING_TEST_PROGRAM)
      , ('etc/aspen.conf', "[logging]level=CRITICAL")
       )
