"""Define a handler that serves static files, with caching.
...
def static(environ, start_response):
    _c = cache.FileCache( max_size=128, mode='rb' ) #@@ MUST talk with config!!!
    return _Static(environ, start_response, cacher=_c)
